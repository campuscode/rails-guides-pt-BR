...
Além desses comandos, existem:
 ...
 db:schema:dump                      Cria um arquivo db/schema.rb (db/schema.rb ou db/structure.sql) ...
 db:schema:load                      Carrega um arquivo schema.rb (db/schema.rb ou db/structure.sql) ...
