...
O *Active Redord* permite que você valide o estado de um modelo antes que ele
...
no banco de dados, então os métodos `save` e `update` consideram quando executados:
