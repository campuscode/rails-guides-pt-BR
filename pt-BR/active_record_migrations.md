...
*Migrations* são uma funcionalidade do *Active Record* que permite expandir nosso esquema do banco de dados com o tempo. Ao invés de escrever modificações no esquema em SQL puro,*migrations* permitem o uso de uma *Ruby DSL* simples para descrever as mudanças em nossas tabelas.
