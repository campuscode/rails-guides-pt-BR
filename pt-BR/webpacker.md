...
Para instalar Webpacker, você precisa instalar o gerenciador de pacotes Yarn, versão 1.x ou acima, e você precisa ter Node.js instalado, versão 10.13.0 ou acima.
