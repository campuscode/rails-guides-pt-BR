...
### A Estrutura Geral da Biblioteca

Desta forma, a *gem* Ruby I18n é dividida em duas partes:

* A API pública do framework i18n - um módulo Ruby com métodos públicos que definem como a biblioteca funciona
* Um backend padrão (que é intencionamlmente chamado _Simple_ backend) que implementa esses métodos

Como usuário, você deve sempre acessar apenas os métodos públicos do módulo I18n, mas é útil conhecer os recursos do backend.
