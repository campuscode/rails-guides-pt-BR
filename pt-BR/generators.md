...
Geradores do Rails são uma ferramenta essencial se você planeja melhorar seu fluxo de trabalho. Com esse guia
você aprenderá como criar Geradores e customizar os já existentes.
...
* Como customizar seu *scaffold* sobrescrevendo os *templates* dos geradores.
* Como customizar seu *scaffold* sobrescrevendo generadores.
